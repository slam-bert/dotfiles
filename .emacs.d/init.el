...
(set-face-attribute 'default nil :font "scientifica" :height 160)	; Set font to the scientifica font
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smart-cursor-color all-the-icons dashboard rainbow-mode evil doom-themes)))
(custom-set-faces
